    ...
    <section id="experience" className="bg-black-100">
      ...
      <div className="flex flex-col mt-5 py-20  md:flex-row w-full bg-black-100 justify-around items-center gap-5  ">
        {companies.map((company) => (
          <BackgroundGradient
            key={company.id}
            className="rounded-[22px] sm:max-w-lg w-full p-4  sm:p-6 sm:pb-12 bg-black-100 mx-auto "
          >
            ...
            <p className="text-sm text-neutral-600 py-3 mt-5 dark:text-neutral-400">
              {company.Description}
            </p>
          </BackgroundGradient>
        ))}
